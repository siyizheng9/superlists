...
class ListViewTest(TestCase):
    ...
    def test_displays_only_items_for_that_list(self):
        ...
        Item.objects.create(text='othe list itemey 1', list=other_list)
        Item.objects.create(text='othe list itemey 2', list=other_list)
    ...
    def test_for_invalid_input_onthing_saved_to_db(self):
